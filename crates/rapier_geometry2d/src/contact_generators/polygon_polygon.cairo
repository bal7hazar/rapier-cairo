...
pub fn contact_manifold_polygon_polygon(
    ...
    polygon_polygon_body(pos12, polygon1, polygon2, prediction, ref manifold);
}
...
/// SAT and clipping: the body of both polygon–polygon entries (inlined in each).
#[inline(always)]
fn polygon_polygon_body(
    pos12: Pose2,
    polygon1: ConvexPolygon,
    polygon2: ConvexPolygon,
    prediction: Fixed,
...
pub fn contact_manifold_polygon_cuboid(
    ...
    polygon_cuboid_body(pos12, polygon1, cuboid2, prediction, flipped, ref manifold);
}
...
/// SAT and clipping: the body of both polygon–cuboid entries (inlined in each).
#[inline(always)]
fn polygon_cuboid_body(
    pos12: Pose2,
    polygon1: ConvexPolygon,
    cuboid2: Cuboid,
    prediction: Fixed,
