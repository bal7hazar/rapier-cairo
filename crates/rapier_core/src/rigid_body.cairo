...
//! body type (and its deprecated alias `BodyStatus`), the change flags, damping, dominance,
//! sleeping state and the `AxesMask` flags.
//!
...
pub use axes_mask::{AxesMask, AxesMaskDefault, AxesMaskImpl, AxesMaskTrait};
pub use body_type::{BodyStatus, RigidBodyType, RigidBodyTypeImpl, RigidBodyTypeTrait};
