...
`CollisionEvent`s; bodies and colliders are built with `RigidBodyBuilder` / `ColliderBuilder` as in Rapier.

## Stability

`0.1.0-alpha.4` is an **alpha**: no API or numeric stability. Every alpha is validated against golden vectors
