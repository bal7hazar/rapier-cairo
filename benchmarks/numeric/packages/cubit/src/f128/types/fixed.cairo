...
// NUMBENCH PATCH: AddAssign impl removed; provided by core bridge from legacy AddEq impl at end of file
...
// NUMBENCH PATCH: SubAssign impl removed; provided by core bridge from legacy SubEq impl at end of file
...
// NUMBENCH PATCH: MulAssign impl removed; provided by core bridge from legacy MulEq impl at end of file
...
// NUMBENCH PATCH: DivAssign impl removed; provided by core bridge from legacy DivEq impl at end of file
...
// NUMBENCH PATCH: legacy compound-assignment impls required by Orion (it pins an older cubit rev).
impl FixedLegacyAddEq of core::traits::AddEq<Fixed> {
    #[inline(always)]
    fn add_eq(ref self: Fixed, other: Fixed) { self = Add::add(self, other); }
}
impl FixedLegacySubEq of core::traits::SubEq<Fixed> {
    #[inline(always)]
    fn sub_eq(ref self: Fixed, other: Fixed) { self = Sub::sub(self, other); }
}
impl FixedLegacyMulEq of core::traits::MulEq<Fixed> {
    #[inline(always)]
    fn mul_eq(ref self: Fixed, other: Fixed) { self = Mul::mul(self, other); }
}
impl FixedLegacyDivEq of core::traits::DivEq<Fixed> {
    #[inline(always)]
    fn div_eq(ref self: Fixed, other: Fixed) { self = Div::div(self, other); }
}
